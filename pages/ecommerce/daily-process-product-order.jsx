...
const DailyProcessProductOrder = (props) => {
  ...
  const [processOrder, updateProcessOrder] = useRecoilState(storeProcessListOfProduct);
  ...
  //     });
  // };
  const processOrders = useRecoilValue(storeProcessListOfProduct);
...
export async function getServerSideProps(context) {
  const { data } = await axios.get(process.env.API_URL + "/DailyProcessOrderList");
  // console.log(data)
  if (!data) {
    return {
      notFound: true,
