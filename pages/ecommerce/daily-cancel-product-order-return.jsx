...
import { storeReturnCancelListOfProduct } from "../../atom/listOfPendingOrder";
import useScript from "../../commonFunction/ReloadJs";

const DailyCancelOrderReturn = (props) => {
  useScript("/assets/js/app.js");

  const getCancelProductList = props.data;
  console.log(getCancelProductList);
  const [returnPendingOrder, updateCancelOrders] = useRecoilState(storeReturnCancelListOfProduct);

  useEffect(() => {
    updateCancelOrders(getCancelProductList);
  }, [updateCancelOrders]);
  ...
  const cancelOrders = useRecoilValue(storeReturnCancelListOfProduct);
...
export default DailyCancelOrderReturn;
