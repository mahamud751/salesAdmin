...
import { storeAllReturnProcessListOfProduct } from "../../atom/listOfAllPending";
import useScript from "../../commonFunction/ReloadJs";

const AllPProcessProductOrderReturn = (props) => {
  useScript("/assets/js/app.js");

  const getProcessReturnProductList = props.data;
  console.log(getProcessReturnProductList);
  const [cancelOrder, updateCancelOrder] = useRecoilState(storeAllReturnProcessListOfProduct);

  useEffect(() => {
    updateCancelOrder(getProcessReturnProductList);
  }, [updateCancelOrder]);
  ...
  //     });
  // };
  const allProcessReturnProduct = useRecoilValue(storeAllReturnProcessListOfProduct);
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {allProcessReturnProduct.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
...
export default AllPProcessProductOrderReturn;
