...
const AllPendingProductOrderReturn = (props) => {
  ...
  const getPendingReturnProductList = props.data;
  console.log(getPendingReturnProductList);
  const [cancelOrder, updatePendingReturn] = useRecoilState(storeAllReturnPendingListOfProduct);

  useEffect(() => {
    updatePendingReturn(getPendingReturnProductList);
  }, [updatePendingReturn]);
  ...
  //     });
  // };
  const allPendingReturnProductList = useRecoilValue(storeAllReturnPendingListOfProduct);
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {allPendingReturnProductList.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
