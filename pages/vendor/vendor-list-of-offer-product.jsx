...
import { storeListOfVendorOfferProduct } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const ListOfVendorOfferProduct = (props) => {
  useScript("/assets/js/app.js");

  const getVendorOfferProduct = props.data;
  console.log(getVendorOfferProduct);
  const [vendorOfferProduct, updateVendorProduct] = useRecoilState(storeListOfVendorOfferProduct);

  useEffect(() => {
    updateVendorProduct(getVendorOfferProduct);
  }, [updateVendorProduct]);
  ...
  //     });
  // };
  const vendorOfferProducts = useRecoilValue(storeListOfVendorOfferProduct);
  console.log(vendorOfferProducts);
        ...
        <div className="col-md-12 m-b-30">
          <div className="d-block d-sm-flex flex-nowrap align-items-center">
            <div className="page-title mb-2 mb-sm-0">
              <h1>List of vendor offer product</h1>
            </div>
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {vendorOfferProducts.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
...
export default ListOfVendorOfferProduct;
