...
import { storeListOfVendorRequest } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const ListOfVendorRequest = (props) => {
  useScript("/assets/js/app.js");

  const getVendorListRequest = props.data;
  console.log(getVendorListRequest);
  const [vendorRequest, updateVendorRequest] = useRecoilState(storeListOfVendorRequest);

  useEffect(() => {
    updateVendorRequest(getVendorListRequest);
  }, [updateVendorRequest]);
  ...
  //     });
  // };
  const vendorsRequest = useRecoilValue(storeListOfVendorRequest);
  console.log(vendorsRequest);
...
export default ListOfVendorRequest;
