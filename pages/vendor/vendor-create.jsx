...
const CreateVendor = () => {
  ...
  const [vendor, updateVendorState] = useState("");

  const categoryHandleChange = (e) => {
    fromValueUpdate(e, updateVendorState);
  };
  console.log(vendor);
  ...
  const vendorHandleSubmit = async (e) => {
    ...
    formValueAppend(formData, vendor);
        ...
        <div className="col-md-10 m-b-30">
          <div className="card card-statistics">
            ...
            <div className="card-body">
              <form onSubmit={vendorHandleSubmit} method="post" className="form-horizontal" encType="multipart/form-data">
                ...
                <div className="form-row">
                  ...
                  <div className="col-md-4">
                    <div className="form-group">
                      ...
                      <select id="inputState" name="district" className="form-control" onChange={categoryHandleChange}>
                        <option>Dhaka</option>
                        <option>Bogura</option>
                      </select>
                    </div>
