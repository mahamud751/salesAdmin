...
import { storeListOfVendorFlashSales } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const ListOfVendorFlashSales = (props) => {
  useScript("/assets/js/app.js");

  const getVendorFlashSales = props.data;
  console.log(getVendorFlashSales);
  const [VendorFlashSale, updateVendorFlashSales] = useRecoilState(storeListOfVendorFlashSales);

  useEffect(() => {
    updateVendorFlashSales(getVendorFlashSales);
  }, [updateVendorFlashSales]);
  ...
  //     });
  // };
  const VendorFlashSales = useRecoilValue(storeListOfVendorFlashSales);
  console.log(VendorFlashSales);
        ...
        <div className="col-md-12 m-b-30">
          <div className="d-block d-sm-flex flex-nowrap align-items-center">
            <div className="page-title mb-2 mb-sm-0">
              <h1>List of vendor flash sales product</h1>
            </div>
              ...
              <nav>
                <ol className="breadcrumb p-0 m-b-0">
                  ...
                  <li className="breadcrumb-item active text-primary" aria-current="page">
                    List of vendor flash sales product
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {VendorFlashSales.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
...
export default ListOfVendorFlashSales;
