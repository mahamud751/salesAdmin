...
import { storeListOfVendorProductPackage } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const ListOfVendorProductPackage = (props) => {
  useScript("/assets/js/app.js");

  const getVendorProductPackage = props.data;
  console.log(getVendorProductPackage);
  const [VendorProductPackage, updateVendorProductPackage] = useRecoilState(storeListOfVendorProductPackage);

  useEffect(() => {
    updateVendorProductPackage(getVendorProductPackage);
  }, [updateVendorProductPackage]);
  ...
  //     });
  // };
  const VendorProductPackages = useRecoilValue(storeListOfVendorProductPackage);
  console.log(VendorProductPackages);
        ...
        <div className="col-md-12 m-b-30">
          <div className="d-block d-sm-flex flex-nowrap align-items-center">
            <div className="page-title mb-2 mb-sm-0">
              <h1>List of Vendor Product Package </h1>
            </div>
              ...
              <nav>
                <ol className="breadcrumb p-0 m-b-0">
                  ...
                  <li className="breadcrumb-item active text-primary" aria-current="page">
                    List of Vendor Product Package
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {VendorProductPackages.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
...
export default ListOfVendorProductPackage;
