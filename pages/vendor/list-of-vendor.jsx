...
import { storeListOfVendor } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const ListOfVendor = (props) => {
  useScript("/assets/js/app.js");

  const getVendorList = props.data;
  console.log(getVendorList);
  const [vendor, updateVendor] = useRecoilState(storeListOfVendor);

  useEffect(() => {
    updateVendor(getVendorList);
  }, [updateVendor]);
  ...
  //     });
  // };
  const vendors = useRecoilValue(storeListOfVendor);
  console.log(vendors);
  return (
    <div>
      <div className="row">
