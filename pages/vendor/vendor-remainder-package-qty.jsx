...
import { storeListOfVendorRemainderPackageStockQty } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const VendorRemainderStockQty = (props) => {
  useScript("/assets/js/app.js");

  const getRemainderPackageStockQty = props.data;
  console.log(getRemainderPackageStockQty);
  const [RemainderStockQty, updateRemainderPackageStockQty] = useRecoilState(storeListOfVendorRemainderPackageStockQty);

  useEffect(() => {
    updateRemainderPackageStockQty(getRemainderPackageStockQty);
  }, [updateRemainderPackageStockQty]);
  ...
  //     });
  // };
  const RemainderPackageStockQty = useRecoilValue(storeListOfVendorRemainderPackageStockQty);
  console.log(RemainderPackageStockQty);
        ...
        <div className="col-md-12 m-b-30">
          <div className="d-block d-sm-flex flex-nowrap align-items-center">
            <div className="page-title mb-2 mb-sm-0">
              <h1>List of vendor product stock qty</h1>
            </div>
              ...
              <nav>
                <ol className="breadcrumb p-0 m-b-0">
                  ...
                  <li className="breadcrumb-item active text-primary" aria-current="page">
                    List of vendor product stock qty
                  </li>
                </ol>
              </nav>
            </div>
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {RemainderPackageStockQty.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
...
export default VendorRemainderStockQty;
