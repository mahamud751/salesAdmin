...
import { storeListOfVendorDiscount } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const ListOfVendorDiscount = (props) => {
  useScript("/assets/js/app.js");

  const getVendorDiscount = props.data;
  console.log(getVendorDiscount);
  const [VendorDiscount, updateVendorDiscount] = useRecoilState(storeListOfVendorDiscount);

  useEffect(() => {
    updateVendorDiscount(getVendorDiscount);
  ...
  //     });
  // };
  const VendorDiscounts = useRecoilValue(storeListOfVendorDiscount);
  console.log(VendorDiscounts);
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {VendorDiscounts.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
...
export default ListOfVendorDiscount;
