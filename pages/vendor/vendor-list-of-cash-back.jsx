...
import { storeListOfVendorCashBack } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const ListOfVendorCashBack = (props) => {
  useScript("/assets/js/app.js");

  const getVendorCashBack = props.data;
  console.log(getVendorCashBack);
  const [VendorCashBack, updateVendorCashBack] = useRecoilState(storeListOfVendorCashBack);

  useEffect(() => {
    updateVendorCashBack(getVendorCashBack);
  }, [updateVendorCashBack]);
  ...
  //     });
  // };
  const VendorCashBacks = useRecoilValue(storeListOfVendorCashBack);
  console.log(VendorCashBacks);
        ...
        <div className="col-md-12 m-b-30">
          <div className="d-block d-sm-flex flex-nowrap align-items-center">
            <div className="page-title mb-2 mb-sm-0">
              <h1>List of vendor cash back </h1>
            </div>
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {VendorCashBacks.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
...
export default ListOfVendorCashBack;
