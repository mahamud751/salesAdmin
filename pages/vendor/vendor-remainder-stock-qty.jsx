...
import { storeListOfVendorRemainderStockQty } from "../../atom/listOfVendor";
import useScript from "../../commonFunction/ReloadJs";

const VendorRemainderStockQty = (props) => {
  useScript("/assets/js/app.js");

  const getRemainderStockQty = props.data;
  console.log(getRemainderStockQty);
  const [RemainderStockQty, updateRemainderStockQty] = useRecoilState(storeListOfVendorRemainderStockQty);

  useEffect(() => {
    updateRemainderStockQty(getRemainderStockQty);
  }, [updateRemainderStockQty]);
  ...
  //     });
  // };
  const RemainderStockQtys = useRecoilValue(storeListOfVendorRemainderStockQty);
  console.log(RemainderStockQtys);
            ...
            <div className="card-body">
              <div className="datatable-wrapper table-responsive">
                <table id="datatable" className="display compact table table-striped table-bordered">
                  ...
                  <tbody>
                    {RemainderStockQtys.map((item, index) => (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        {/* <td>
